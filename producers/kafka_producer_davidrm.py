...
def generate_messages(producer, topic, interval_secs):
    ...
    """
    string_list: list = [
        "Did you know Kafka is named after Franz Kafka?",
        "Streaming data, one buzz at a time",
        "Kafka is reliable",
        "Kafka makes streaming easy",
        "Data streaming is cool",
    ]
    try:
        while True:
